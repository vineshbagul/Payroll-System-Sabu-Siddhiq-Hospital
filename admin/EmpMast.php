...
<html>
    ...
    <body>
        ...
        <div class="container-fluid">
            ...
            <div class="jumbotron">
                <div >
                    <p style="text-align: center;font-size: 30px;color: #4B4276;font-weight: bold;"> Employee Details</p></div>
                    <div class="col-lg-2"></div>
                    <div class="col-lg-10" >
                        <div class="col-lg-3">
                            <div class="col mt-3">
                                <input type="text" id="empcode" class="form-control"  placeholder="Employee Code">
                            </div>
                        </div>
                        <div class="col-lg-3">
                            <div class="col mt-3">
                                        ...
                                        <div class="panel-body">
                                            <div class="well well-sm ">
                                                ...
                                                <div class="col "  >
                                                    ...
                                                    <input  class="form-control" type="text" placeholder="Pick the Date"  id="date1">
                                                    
                                                </div>
                                                <div class="col"  >
                                                    <label>Date of Confirm  :</label>
                                                    <input  class="form-control" type="text" placeholder="Pick the Date"  id="date2">
                                                </div>
                                                <div class="col" >
                                                    <label>Date of Joined  :</label>
                                                    <input  class="form-control" type="text" placeholder="Pick the Date"  id="date3">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                            ...
                                            <div class="panel-body">
                                                <div class="well well-sm ">
                                                    ...
                                                    <div class="col ">
                                                        ...
                                                        <input  class="form-control" type="text" placeholder="Pick the Date"  id="date4">
                                                    </div><br>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="panel panel-default">
                                                ...
                                                <div align="center">
                                                    <button type="button" name="submit" onclick="SaveEmpoffDetails()"  class="btn btn-success">Save</button>
                                                </div>
                                            </div>
                                        </div>
                                        <!-- personal details -->
                                        <div id="Personal" class="tabcontent">
                                            <div class="row">
                                                            ...
                                                            <div class="panel-body">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        ...
                                                                        <input  class="form-control" type="text" placeholder="Pick the Date"  id="date5">
                                                                        
                                                                    </div><br>
                                                                    <div class="col-lg-6" >
                                                                        <label>Date of Expiry:</label>
                                                                        <input  class="form-control" type="text" placeholder="Pick the Date"  id="date6">
                                                                        
                                                                    </div><br>
                                                                    <div class="col-lg-6" >
                                                                        <label>Date of Birth:</label>
                                                                        <input  class="form-control" type="text" placeholder="Pick the Date"  id="date7">
                                                ...
                                                <div class="col-lg-10">
                                                    ...
                                                    <div align="center">
                                                        <button class="btn btn-success" onclick="SaveEmppersonalDetails()">Save</button>
                                                    </div>
                                                </div>
                                                <!-- closing tab person -->
                                            </div>
                                        ...
                                        <div id="Family" class="tabcontent">
                                            ...
                                            <div class="col-lg-10">
                                                ...
                                                <div align="center">
                                                    <button class="btn btn-success" onclick="SaveEmpFamilyDetails()" style="float: center;">Save</button>
                                                </div>
                                            </div>
                                            ...
                                            <div id="Qualification" class="tabcontent">
                                                <div class="row">
                                                    ...
                                                    <div align="center">
                                                        <button class="btn btn-success" onclick="SaveEmpQuali()" style="float: center;">Save</button>
                                                    </div>
                                                        ...
                                                        <div class="col-lg-10">
                                                            <form class="ajaxForm">
                                                                <div class="panel panel-default" >
                                                                    ...
                                                                    <div align="center">
                                                                        <button type="button" onclick="SaveEmpRef()" class="btn btn-success" >Save</button>
                                                                    </div>
                                                                </form>
                                                            </div>
                                                ...
                                                success:function(res){
                                                    ...
                                                    {
                                                       alert("Official details have been saved!!")
                                                    } 
                                                ...
                                                //////////////// /////////////////// personal details/////////////////////////////////////////////////////
                                                ////////////// /////////////////////////////////////////////////////////////////////////////////////////
                                                function SaveEmppersonalDetails()
                                                ...
                                                alert("Family details have been saved!!")
                                                ...
                                                alert("Qualification details have been saved!!")
                                                ...
                                                alert("Reference details have been saved!!")
